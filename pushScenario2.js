...
async function pushScenario2() {
    const dateOnly = "2026-05-15";
    const timeOnly = "00:40:00"; 
    const createdOn = `${dateOnly} ${timeOnly}`;
    const orderID = `FITGREEN-TEST-402`;
            ...
            "OrderInfo": {
                ...
                "Order": {
                    "details": {
                        ...
                        "discount_total": "0.00",
                        "discount_type": "F",
                        "description": "Scenario 2 - Item with Addon + Tax",
    ...
    console.log(`🚀 Executing Scenario 2 (Addon Test: ${orderID})...`);
    try {
        const response = await axios.post(SAVE_ORDER_URL, payload);
        console.log(`✅ Response:`, JSON.stringify(response.data));
        
        fs.writeFileSync('scenario2_request.json', JSON.stringify(payload, null, 2));
        fs.writeFileSync('scenario2_response.json', JSON.stringify(response.data, null, 2));
    } catch (error) {
